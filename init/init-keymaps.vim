...
function! s:run_myrg_cword()
	execute "Rg"." ".expand("<cword>")
endf
nnoremap <leader>f :call <SID>run_myrg_cword()<CR>
function! s:run_myrg()
	execute "Rg"
endf
...
" 切换头文件 alt+o
function! s:switch_SourceHeader()
  if (index(['cc','cpp', 'h', 'hpp'], &filetype) >= 0)
	if(coc#rpc#ready())
		execute ":CocCommand clangd.switchSourceHeader"
	endif
  endif
endfunction
noremap <silent> <m-o> :call <SID>switch_SourceHeader()<CR>
